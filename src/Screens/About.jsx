    ...
    <div>
      <section id="about" className="p-10 bg-white mt-[50px]">
        ...
        <div className='flex items-center justify-around w-full flex-wrap'>
          ...
          <div className='flex flex-col gap-8 '>
            <div className='flex flex-row gap-4 '>
              <div className='flex flex-col items-center gap-1 border-2 rounded-md p-2  hover:bg-gray-100'>
                <div><FaLightbulb size={20} color='orange' /></div>
                <p>Experience</p>
                <p className='text-gray-400'>2+ years</p>
              </div>
              <div className='flex flex-col items-center gap-1 border-2 rounded-md p-2 w-[120px] hover:bg-gray-100'>
                <div><GrCompliance size={20} color='orange' /></div>
                <p>Completed</p>
                <p className='text-gray-400'>25+ projects</p>
              </div>
              <div className='flex flex-col items-center gap-1 border-2 rounded-md w-[120px] p-2 hover:bg-gray-100'>
        ...
        <div className="flex flex-col items-center">
          ...
          <div className='flex items-center justify-center flex-col bg-slate-100 border-2 border-[orange] mt-4 w-[500px] h-[300px] rounded-md shadow-2xl hover:shadow-slate-800'>
            <h2 className='font-thin underline'>Frontend development & UI/UX Design</h2>
            <div className="flex items-center justify-around gap-2 flex-wrap mt-5">
              <div className='flex gap-1 items-center'>
                <MdVerified color="orange" size="20"/>
        ...
        <div>
        <h2 className="text-3xl font-bold text-center mb-5 text-[orange] mt-16">Education</h2>
       <EducationSection/>
        </div>
      </section>
    </div>
